...
private:
    ...
    double CalculatePassive(const int base, const int correction_arc, const double correction_pct_arc,
                            const int stat_max_0, const int stat_max_1, const int stat_max_2, const int stat_max_3,
                            const int stat_max_4,
                            const int grow_0, const int grow_1, const int grow_2, const int grow_3, const int grow_4,
                            const double adj_pt_grow_0, const double adj_pt_grow_1, const double adj_pt_grow_2,
                            const double adj_pt_grow_3, const double adj_pt_grow_4) const;

    static void EvaluateByAR(const int s, const int d, const int i, const int f, const int a, ERBuildOptimizer &er);

    static void
    EvaluateBySkillAR(const int s, const int d, const int i, const int f, const int a, ERBuildOptimizer &er);
    ...
    static double CalculateCorrectedDamage(const Weapon &selected_weapon,
                                           const int s, const int d, const int i, const int f, const int a,
                                           const DAMAGE_TYPE damage_type, const double base_damage,
                                           const bool is_two_handing);

    static inline double
    CalculateCorrectFn(const double attribute, const int stat_max[], const int grow[], const double adj_pt_grow[]);

    static inline double
    CalcCorrectFnInner(const double attribute, const int stat_max, const int stat_max_n, const int grow,
